...
Este projeto em **C#** foi feito para treinar POO, especificamente o método **foreach** no console, que remove um ou mais itens da lista dentro de uma condição pré-estabelecida.
